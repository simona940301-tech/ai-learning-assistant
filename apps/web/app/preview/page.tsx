        ...
        <div className="max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 shadow-2xl border border-white/20">
            <div className="text-center mb-8">
              <h1 className="text-4xl font-bold text-white mb-2">🎛️ Preview Mode</h1>
              <p className="text-white/80 text-lg">Batch 1.5 Hotfix Configuration</p>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-white/60 text-sm">HMR enabled • Changes will reflect instantly</p>
              <p className="text-white/60 text-sm mt-1">
                Press{' '}
                <kbd className="px-2 py-1 bg-white/20 rounded text-white/80 font-mono text-xs">
                  F12
                </kbd>{' '}
                to open DevTools
              </p>
