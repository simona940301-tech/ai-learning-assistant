...
export default function OnboardingAvatarPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF6E9] px-6" style={{
      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <p className="text-base text-[#7A5A3A] leading-relaxed">
            選擇一個頭像！下一步就會進入 1v1 小對戰，這場小遊戲的表現會幫助我們快速了解你的程度。
          </p>
        </motion.div>
