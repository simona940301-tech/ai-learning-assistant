...
-- =====================================================
-- This migration creates a comprehensive proficiency tracking system
-- that records historical proficiency changes and enables advanced analytics
...
CREATE INDEX idx_user_proficiency_calculated_at ON user_proficiency(calculated_at DESC);
CREATE INDEX idx_user_proficiency_user_latest ON user_proficiency(user_id, calculated_at DESC);
...
CREATE INDEX idx_user_subject_proficiency_user_id ON user_subject_proficiency(user_id);
CREATE INDEX idx_user_subject_proficiency_subject ON user_subject_proficiency(subject);
...
CREATE INDEX idx_user_concept_proficiency_user_id ON user_concept_proficiency(user_id);
CREATE INDEX idx_user_concept_proficiency_concept ON user_concept_proficiency(concept_tag_id);
CREATE INDEX idx_user_concept_proficiency_next_review ON user_concept_proficiency(next_review_at);
CREATE INDEX idx_user_concept_proficiency_mastery ON user_concept_proficiency(mastery_level);
...
COMMENT ON TABLE user_proficiency IS 'Historical tracking of user overall proficiency with weighted composite scoring';
COMMENT ON TABLE user_subject_proficiency IS 'Subject-specific proficiency tracking for targeted learning';
COMMENT ON TABLE user_concept_proficiency IS 'Concept-level mastery tracking with SRS scheduling';
COMMENT ON FUNCTION update_concept_proficiency IS 'Updates concept proficiency using SM-2 spaced repetition algorithm';
