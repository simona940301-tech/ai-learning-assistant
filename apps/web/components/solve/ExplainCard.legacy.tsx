...
interface ExplainCardLegacyProps {
  card: ExplainCardModel | null
  actionsDisabled?: boolean
}

/**
 * @deprecated Legacy ExplainCard component - no longer used
 * This file is kept for reference only
 */
export default function ExplainCardLegacy({ card, actionsDisabled = false }: ExplainCardLegacyProps) {
