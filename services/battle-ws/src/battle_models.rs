...
pub enum ClientMessage {
    ...
    #[serde(rename = "LEAVE_BATTLE")]
    LeaveBattle { match_id: String },
...
pub enum ServerMessage {
    ...
    AnswerResult {
        ...
        tempo_hint: String,
        arousal_level: f32,
        mystery_window_hint: MysteryHint,
        #[serde(skip_serializing_if = "Option::is_none")]
        reward_popup: Option<RewardPopupPayload>,
    },
    ...
    BattleEnd {
        ...
        retest_suggestions: Vec<RetestSuggestion>,
        recall_overlay: RecallOverlayPayload,
    },
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RewardPopupPayload {
    pub items: Vec<RewardItemPayload>,
    pub source: String,
...
pub struct MysteryHint {
    pub active: bool,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RetestSuggestion {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RecallOverlayPayload {
    pub duration_sec: i32,
    pub items: Vec<RecallPrompt>,
}

impl Default for RecallOverlayPayload {
    fn default() -> Self {
        Self {
            duration_sec: 30,
            items: Vec::new(),
...
impl MatchMode {
    pub fn from_metadata(match_type: &str, opponent_id: &str) -> Self {
        if opponent_id == "AI"
            || match_type.eq_ignore_ascii_case("PVE_TRAINING")
            || match_type.eq_ignore_ascii_case("PVE_CHALLENGE")
        {
            MatchMode::Bot
        } else {
            MatchMode::Pvp
...
pub struct Match {
    ...
    pub match_type: String, // "PVP" | "PVE_TRAINING" | "PVE_CHALLENGE"
    pub mode: MatchMode,
    pub init_theme_choice: Option<String>,
...
impl Match {
    ...
    pub fn new_with_config_and_type(
        ...
        let mode = MatchMode::from_metadata(&match_type, &player2_id);
        Self {
            id,
            player1_id,
            player2_id,
...
impl Clone for Match {
    fn clone(&self) -> Self {
        Self {
            ...
            mode: self.mode,
            init_theme_choice: self.init_theme_choice.clone(),
